...
MANAGER_CMD="cd $ROOT_Q && ./scripts/autopilot/manager_loop.sh --cli codex --project-root $PROJECT_Q --interval '$MANAGER_INTERVAL' --log-dir $LOG_Q"
CLAUDE_CMD="cd $ROOT_Q && ./scripts/autopilot/worker_loop.sh --cli claude --agent claude_code --project-root $PROJECT_Q --interval '$WORKER_INTERVAL' --log-dir $LOG_Q"
GEMINI_CMD="cd $ROOT_Q && ./scripts/autopilot/worker_loop.sh --cli gemini --agent gemini --project-root $PROJECT_Q --interval '$WORKER_INTERVAL' --log-dir $LOG_Q"
